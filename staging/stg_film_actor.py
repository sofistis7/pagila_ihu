...
with base as (
  select *
  from `studied-brand-481913-u8.postgres_productionpublic.film_actor` --Your table path
  )
...
schema = [
    ...
    bigquery.SchemaField('film_actor_film_id', 'INTEGER'),
...
get_ipython().system('python3 -m jupyter nbconvert stg_film_actor.ipynb --to python')
