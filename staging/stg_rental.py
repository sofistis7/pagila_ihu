...
with base as (
  select *
  from `studied-brand-481913-u8.postgres_productionpublic.rental` --Your table path
  )
...
schema = [
    ...
    bigquery.SchemaField('rental_return_date', 'INTEGER'),
    bigquery.SchemaField('rental_staff_id', 'STRING'),
...
get_ipython().system('python3 -m jupyter nbconvert stg_rental.ipynb --to python')
