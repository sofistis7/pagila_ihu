...
with base as (
  select *
  from `studied-brand-481913-u8.postgres_productionpublic.payment` --Your table path
  )
...
schema = [
    ...
    bigquery.SchemaField('payment_amount', 'NUMERIC', precision=5, scale=2),
...
get_ipython().system('python3 -m jupyter nbconvert stg_payment.ipynb --to python')
