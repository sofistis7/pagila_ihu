...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "/Users/nikolas/Documents/_Επιμόρφωση/_Data_Analytics_Modern_Corporate_Business/Capstone_Project_Resources/studied-brand-481913-u8-0f4005891f76.json" # Edit path
...
project_id = 'studied-brand-481913-u8' # Edit with your project id
...
with base as (
  select *
  from `studied-brand-481913-u8.postgres_productionpublic.film` --Your table path
  )
...
schema = [
    ...
    bigquery.SchemaField('film_rental_rate', 'NUMERIC', precision=4, scale=2),
    bigquery.SchemaField('film_length', 'INTEGER'),
    bigquery.SchemaField('film_replacement_cost', 'NUMERIC', precision=5, scale=2),
...
get_ipython().system('python3 -m jupyter nbconvert stg_film.ipynb --to python')
